        ...
        <section className="w-full flex flex-col">
                    ...
                    <div className="w-full flex flex-col md:flex-row items-start md:items-center justify-between px-1 gap-4">
                        <div className="flex flex-row items-center gap-x-4">
                            <span className="inline-block p-2 md:p-3 bg-emerald-100 rounded-md border border-emerald-200">
                                <UserRoundPen className="size-5 md:size-6 text-emerald-600" />
                            </span>
                            <div className="flex flex-col">
                                <h1 className="text-xl md:text-2xl font-bold text-emerald-800">User Profile</h1>
            ...
            <form onSubmit={handleSubmit} className="mt-4">
                <div className="w-full flex flex-col justify-center items-center gap-2">
                    <div className="flex flex-col lg:flex-row justify-center items-center gap-6 w-full max-w-4xl pb-2 lg:pb-6">
                        ...
                        <div className="flex flex-col gap-2 w-full max-w-xl">
                            ...
                            <div className="grid grid-cols-1 lg:grid-cols-2 gap-2 gap-y-4 w-full">
                                <DatePicker
                                    label="Birth Date"
                    ...
                    <div className="flex flex-col gap-2 w-full max-w-4xl md:ps-10">
                        ...
                        <div className="w-full pt-4 flex flex-row justify-center lg:justify-end">
